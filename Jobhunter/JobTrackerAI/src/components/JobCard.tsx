...
export function JobCard({ job, onEdit, onDelete, onApply }: JobCardProps) {
  const {
    setNodeRef,
    attributes,
    listeners,
...
<div className="flex flex-shrink-0 items-center gap-2">
          ...
          <button onClick={(e) => { e.stopPropagation(); if (onApply) onApply(job); }} className="px-2 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
            Apply
          </button>
        </div>
      </div>
