...
| `n8n_AIAgent/AI_3X_05_Social_media_AI agent.json` | Daily-scheduled 4-agent pipeline: topic generation → content writing (LinkedIn/Medium/IG/YT) → Imagen 3.0 image generation → Google Sheets logging, with images uploaded to Drive. |
| `n8n_AIAgent/AI_3X_05_Social_media_AI agent (1).json` | Same pipeline, image node swapped to `gemini-3.1-flash-image-preview` instead of Imagen 3.0. |
...
| `n8n_AIAgent/Resume_Gen/` | Sample resume output (`Pramod_Dutta_Resume_2026.docx`) generated by the resume-tailor workflow/skill for reference. |
